...
quality. {\color{blue}%
Our aim is a smaller evidence set at unchanged detection
accuracy, not a higher accuracy than prior IoMT detectors. Reported
accuracies are also protocol-dependent, so we compare against models
trained and evaluated under our own protocol.%
}
